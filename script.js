...
var posicion = /** @class */ (function () {
    ...
    posicion.prototype.getX = function () {
        return this.x;
    };
    posicion.prototype.getY = function () {
        return this.y;
    };
    return posicion;
}());
...
var bola = /** @class */ (function () {
    ...
    bola.prototype.getPos = function () {
        return this.pos;
    };
    return bola;
}());
//CLASE BARRERA
var barrera = /** @class */ (function () {
    function barrera(pos) {
        this.pos = pos;
    }
    barrera.prototype.getPos = function () {
        return this.pos;
    };
    return barrera;
}());
...
var posBarrera1 = document.getElementById("barrera1").style.top;
posBarrera1 = posBarrera1.substring(0, posBarrera1.length - 2);
posBarrera1 = parseInt(posBarrera1);
var posBarrera2 = document.getElementById("barrera2").style.top;
